...
function questions() {
  ...
  text('Will this ever end?', 450, 300);
  textSize(10);
  fill(255);
  text('SANITY:' + health, 0, 100, 150);
  stroke(255);
  textSize(35);
  text('Hope for the best', 300, 100);
  stroke(255);
  textSize(35);
  text('Is it over yet?', 350, 250);
  stroke(255);
  textSize(35);
...
function youWin() {
  ...
  text('Are you happy?', 450, 300);
  textSize(10);
  fill(255);
  text('SANITY:' + health, 0, 100, width / 2);
}
